...
barcodes=read.table(gzfile("..//data//SNU601_scATACseq//barcodes.tsv.gz"), 
                    ...
                    stringsAsFactors = F, 
                    header=F)
alt_all=readMM("..//data//SNU601_scATACseq//vartrix_out//alt_all.mtx")
ref_all=readMM("..//data//SNU601_scATACseq//vartrix_out//ref_all.mtx")
var_all=read.table("..//data//SNU601_scATACseq//vartrix_out//var_all.vcf", 
                   header = F, 
                   sep='\t', 
                   stringsAsFactors = F)
